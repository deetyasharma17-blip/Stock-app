# Read the file
$content = [System.IO.File]::ReadAllText("$PSScriptRoot\script.js")
...
# Write back
[System.IO.File]::WriteAllText("$PSScriptRoot\script.js", $content)
Write-Host "Quiz levels updated successfully!"
